...
public class DynamicSqlQueryToJavaListExcatRowDiff2 {
	public static void main(String[] args) {
		...
		// Example query file paths
		String queryFilePath1 = "./testcases/source/source.sql";
		String queryFilePath2 = "./testcases/target/target.sql";

		// Read queries from files
		String query1 = readQueryFromFile(queryFilePath1);
		String query2 = readQueryFromFile(queryFilePath2);
